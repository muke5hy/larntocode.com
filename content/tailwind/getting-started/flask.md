...
Let's start by adding a <a href="{{< ref "tailwind/components/navbar" >}}">Navbar component</a> inside the `index.html` file:
  ...
  <body>
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
      <div class="container flex flex-wrap items-center justify-between mx-auto">
        <a href="https://larntocode.com/" class="flex items-center">
          <img src="https://larntocode.com/docs/images/logo.svg" class="h-6 mr-3 sm:h-9" alt="Flowbite Logo" />
...
Other than the base components from the library you can also check out some of the free and premium website sections from [Flowbite Blocks](https://larntocode.com/blocks/) such as hero sections, pricing sections, contact sections, and more.

Let's add a free [Tailwind CSS hero section](https://larntocode.com/blocks/marketing/hero/) just after the navigation bar:
