...
To enable interactivity via data attributes and the Drawer API you need to include [Flowbite's JavaScript file]({{< ref "tailwind/getting-started/quickstart" >}}).
...
>
  ...
  <p class="mb-6 text-sm text-gray-500 dark:text-gray-400">
    ...
    <a href="#" class="text-blue-600 underline dark:text-blue-500 hover:no-underline">limited-time sale</a> for Flowbite Docs + Job Board. Unlimited
