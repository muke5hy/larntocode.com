...
Follow the [quickstart guide]({{< ref "tailwind/getting-started/quickstart" >}}) and then include the following JavaScript file:
...
If you would like to enable dark mode for the datepicker please follow the [dark mode]({{< ref "tailwind/customize/dark-mode" >}}) guide on Flowbite and enable it either manually or by using a dark mode switcher.
